...
class ItemCRUD extends CI_Controller {
   ...
   */
   ...
   {
    //    var_dump('aa');die;
        $this->form_validation->set_message('is_unique', 'The description is already taken');
        $this->form_validation->set_rules('title', 'Title', 'required');
        $this->form_validation->set_rules('description', 'Description', 'required|is_unique[items.description]');
   ...
   */
   public function update($id)
   {
        ...
        $this->form_validation->set_rules('title', 'Title', 'required|is_unique[items.title]');
